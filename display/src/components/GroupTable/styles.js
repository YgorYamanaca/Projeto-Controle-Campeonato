...
export const GroupTableTitle = styled.div`
    ...
    align-items: center;
`;
export const GroupTableContent = styled.div`
    margin:15px 15px 0 15px;
    display: flex;
    flex-direction: column;
`;
export const GroupTableFooter = styled.div`
    display:flex;
    background-color: #00527E;
    margin-top: auto;
    padding:10px;
...
`;
export const GroupCellTeamTableRowSty = styled.div`
    display: grid;
...
export const GroupTeamRowEmpety = styled.div`
    display: flex;
    justify-content: center;
